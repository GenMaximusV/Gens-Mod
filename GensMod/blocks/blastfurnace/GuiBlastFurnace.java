...

{
	...
	private static final ResourceLocation BLAST_FURNACE_TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/gui/blast_furnace.png");
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.mc.getTextureManager().bindTexture(BLAST_FURNACE_TEXTURE);
