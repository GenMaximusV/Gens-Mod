...

{
	...
	{
		return this.hasCustomName() ? this.furnaceCustomName : "container.recycler";
	}
	...
	{
		fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityRecycler.class, new String[] {"Items"}));
	}
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                Recycler.setState(this.isBurning(), this.world, this.pos);
            }
        }
        if (flag1)
        {
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = RecyclerRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
            if (itemstack.isEmpty())
            {
                return false;
            }
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = RecyclerRecipes.instance().getCookingResult(itemstack);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) 
    {
    	...
    	{
    		ItemStack itemStack = this.furnaceItemStacks.get(1);
    		return isItemFuel(stack) || SlotRecyclerFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
    	}
    }
