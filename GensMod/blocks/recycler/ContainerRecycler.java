...
public class ContainerRecycler extends Container
{
	...
	public ContainerRecycler(InventoryPlayer playerInventory, IInventory furnaceInventory) 
	{
		this.tileFurnace = furnaceInventory;
		this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
		this.addSlotToContainer(new SlotRecyclerFuel(furnaceInventory, 1, 56, 53));
		this.addSlotToContainer(new SlotRecyclerOutput(playerInventory.player, furnaceInventory, 2, 116, 35));
		for(int i = 0; i < 3; i++)
		{
			for(int j = 0; j < 9; ++j)
			{
...

	{
...

        {
...

            {
                ...
                if (!RecyclerRecipes.instance().getCookingResult(itemstack1).isEmpty())
