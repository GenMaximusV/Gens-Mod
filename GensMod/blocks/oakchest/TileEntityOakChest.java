...
public class TileEntityOakChest extends TileEntityLockableLoot implements ITickable 

{
...

	{
		...
		return this.hasCustomName() ? this.customName : "Oak Chest";
...

	{
		...
		return new ContainerOakChest(playerInventory, this, playerIn);
...

	{
		...
		return Reference.MOD_ID + ":oak_chest";
...

	{
...

        {
...

            {
                ...
                if (entityplayer.openContainer instanceof ContainerOakChest)

                {

                    if (((ContainerOakChest)entityplayer.openContainer).getChestInventory() == this)
